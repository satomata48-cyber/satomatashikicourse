...
{:else if space}
	<div class="min-h-screen bg-gray-50">
		...
		<!-- Hero Section -->
		<section 
			class="py-20 text-white relative overflow-hidden"
							...
							<div class="bg-white/20 backdrop-blur-sm rounded-lg p-6 inline-block">
								<p class="text-white/90">
									{#if enrollmentStatus === 'suspended'}
										アカウントが停止されています。講師にお問い合わせください。
									{:else if enrollmentStatus === 'completed'}
										おめでとうございます！学習を修了されました。
									{/if}
								</p>
							</div>
						{/if}
					...
					{:else}
						<div class="space-x-4">
							...
							<a
								...
								class="inline-flex items-center border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors duration-200"
							>
								既にアカウントをお持ちの方
							</a>
						</div>
			...
			<section class="py-16">
				<div class="container mx-auto px-6">
					<div class="text-center mb-12">
						<h2 class="text-3xl font-bold text-gray-900 mb-4">提供コース</h2>
						<p class="text-xl text-gray-600">質の高い学習コンテンツをご用意しています</p>
					</div>
							...
							<div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
								<div class="p-6">
									...
									<a
										...
										class="block w-full text-center bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors duration-200"
									>
										詳細を見る
									</a>
								</div>
			...
			<section class="py-16 bg-white">
				<div class="container mx-auto px-6">
					<div class="max-w-4xl mx-auto text-center">
						<h2 class="text-3xl font-bold text-gray-900 mb-8">講師紹介</h2>
