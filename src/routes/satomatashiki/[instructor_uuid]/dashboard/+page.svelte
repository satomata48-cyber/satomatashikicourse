	...
	{:else}
		...
		<div class="bg-white rounded-lg shadow p-6 mb-8">
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
				<a
					href="/satomatashiki/{data.user.id}/dashboard/space/create"
				...
				<a
					href="/satomatashiki/{data.user.id}/dashboard/course/create"
				...
				<a
					href="/satomatashiki/{data.user.id}/dashboard/spaceview"
